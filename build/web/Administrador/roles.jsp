  ...
  <main class="pt-5 mx-lg-5">
    <div class="container-fluid">
        ...
        <sql:query dataSource="${dbsource}" var="result">
            ...
            <a href='addRoles.jsp'><i class="fas fa-plus"></i> Agregar roles</a>
        <center>
            <table style="margin-top: 10px;" class="table table-striped table-bordered" id="deptotable" width="100%">
                ...
                <c:forEach var="row" items="${result.rows}">
                    <tr>
                        ...
                        <td><c:out value="${row.rol}"/></td>
                        <td><c:out value="${row.descripcion}"/></td>
                        <td><a style='color:#009382; font-weight: bold' href="updRoles.jsp?id=<c:out value="${row.id}"/>">Modificar</a></td>
                        <td><a style='color:#f44336; font-weight: bold' href="delRoles.jsp?id=<c:out value="${row.id}"/>">Borrar</a></td>
                    </tr>
                </c:forEach>
            </table>
